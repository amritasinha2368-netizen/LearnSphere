    ...
    <main className="login-page minimal-login">
      ...
      >
        <form className="login-card compact-login-card" onSubmit={handleSubmit}>
          ...
          <p className="login-hint" style={{ color: error ? '#ef4444' : '#64748b' }}>
            {error ? error : `Demo credentials: ${CREDENTIALS[selectedRole].username} / ${CREDENTIALS[selectedRole].password}`}
          </p>
